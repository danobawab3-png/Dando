...
@app.route('/')
def home():
    return "البوت المصلح يعمل بنجاح 24 ساعة!"

def run_web_server():
    app.run(host='0.0.0.0', port=8080)

# ⚠️ بيانات التلغرام الصحيحة والمضمونة الخاصة بك مدمجة
...
def send_to_telegram(text):
    ...
    try:
        ...
        print(f"استجابة تلغرام الفورية: {res.status_code}")
...
def main_scanner_loop():
    ...
    # 🔥 الإرسال الفوري والمباشر: تم وضعه خارج أي حلقات ليرسل في أول ثانية تشغيل ويفك العقدة!
    send_to_telegram("🚀 *تم إطلاق البوت بنجاح!* خط الاتصال السحابي مستيقظ ويقنص صفقات Solana الحية الآن...")
            ...
            if res.status_code == 200:
                ...
                if isinstance(tokens_list, list):
                    for token_data in tokens_list:
                        ...
                        # ✅ الإصلاح الحاسم الحتمي: أخذ المسبح الأول كعنصر مستقل سليم لتجنب الانهيار
                        pair = pairs_list[0]
