...
@app.route('/')
def home():
    return "تم إصلاح آلية التشفير والفحص يعمل بنجاح ساحق!"

def run_web_server():
    app.run(host='0.0.0.0', port=8080)

# ⚠️ بيانات التلغرام الصحيحة والمؤمنة الخاصة بك
...
def main_scanner_loop():
    ...
    # 🔥 الإرسال الفوري الآمن: سيرسل الآن بنجاح لأننا أصلحنا تشفير الرابط
        ...
        try:
            ...
            if res.status_code == 200 and isinstance(res.json(), list):
                for token_data in res.json():
                    ...
                    # ✅ الإصلاح الحاسم: أخذ المسبح الأول كعنصر مستقل صحيح
                    pair = pairs_list[0]
                    ...
                    # 📢 بث الإشارة الحية الفورية إلى تلغرام بالتنسيق الجديد النظيف
