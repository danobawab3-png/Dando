...
@app.route('/')
def home():
    return "البوت شغال 24 ساعة بنجاح ساحق ومؤمن!"
...
def main_scanner_loop():
    print("🤖 بدأ محرك الفحص المصلح العمل بصفة رسمية...")
    seen_tokens = set()
    
    # 🔥 إرسال فوري ومباشر عند الإقلاع للتأكد من فك العقدة وسلامة خط البث
    send_to_telegram("🚀 *تم إطلاق الخوارزمية بنجاح!* خط الاتصال السحابي يعمل الآن بكفاءة 100% والفلاتر مستيقظة لقنص صفقات Solana...")
        ...
        try:
            ...
            if res.status_code == 200 and isinstance(res.json(), list):
                for token_data in res.json():
                    ...
                    # ✅ الإصلاح البرمجي الصحيح والحاسم: استخراج المسبح الأول كعنصر مستقل
                    pair = pairs_list[0]
